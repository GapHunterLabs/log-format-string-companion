package dev.gaphunter.logformatstringcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.logformatstringcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.logformatstringcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Log Format String Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33680-log-format-string-companion/reviews"
